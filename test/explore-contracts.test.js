...
test(
  "standalone Explore contract stays in parity with the monorepo contract",
  {
  ...
  async () => {
    ...
    assert.deepEqual(
      standalone.EXPLORE_HANDOFF_DESTINATIONS,
      canonical.EXPLORE_HANDOFF_DESTINATIONS,
    );
    ...
    const policyCases = [
      ...
      {
        policy: { mode: "live", allowedChannels: ["cli"] },
        channel: "cli",
        workspaceId: "workspace-1",
      },
      {
        policy: { mode: "live", allowedChannels: ["app"] },
        channel: "cli",
        workspaceId: "workspace-1",
      },
      {
        policy: { allowlistedWorkspaceIds: ["workspace-1"], allowedChannels: ["agent"] },
        channel: "cli",
        workspaceId: "workspace-1",
      },
      {
        policy: { allowlistedWorkspaceIds: ["workspace-1"] },
        channel: "cli",
      ...
      {
        policy: { mode: "live", allowedChannels: ["cli", 7] },
        channel: "cli",
        workspaceId: "workspace-1",
      },
    ];
